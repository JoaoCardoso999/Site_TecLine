...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['listar'])) {
  ...
  try {
    $sql = "SELECT
              ...
              b.link                   AS link,
              b.CategoriaProdutos_id   AS categoria_id,
              c.nome                   AS categoria_nome
            FROM Banners b
            LEFT JOIN Categoria_Produtos c
              ON c.idCategoria_Produtos = b.CategoriaProdutos_id
...
// alterar para o nome da página html que você está utilizando
    ...
    $setSql = "descricao = :desc, data_validade = :dt, link = :lnk, CategoriaProdutos_id = :cat";
    if ($imgBlob !== null) {
...
try {
  ...
  $sql = "INSERT INTO Banners (imagem, data_validade, descricao, link, CategoriaProdutos_id)
